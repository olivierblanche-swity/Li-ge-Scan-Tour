  ...
  return `
    <section class="relative isolate overflow-hidden bg-slate-950">
      ...
      <div class="relative z-10 mx-auto flex min-h-[82vh] max-w-7xl flex-col justify-end px-4 py-16 text-white lg:px-6">
        <div class="animate-soft-in max-w-3xl rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl backdrop-blur-md md:p-8">
          ...
          <div class="mt-8 flex flex-col gap-4 sm:flex-row">
            <button
              class="nav-link inline-flex items-center justify-center rounded-2xl bg-cyan-400 px-8 py-4 text-lg font-bold text-slate-950 shadow-lg shadow-cyan-500/20 transition hover:-translate-y-0.5 hover:bg-cyan-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-200"
              data-page="scanner"
            >
              Prendre une photo
            </button>
            ...
            <button
              class="nav-link rounded-2xl bg-white px-8 py-4 text-lg font-bold text-blue-800 shadow-lg transition hover:-translate-y-0.5 hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/40"
              data-page="monuments"
            >
              Voir les monuments
            </button>
